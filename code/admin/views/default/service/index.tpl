	...
	<div class="span3">
          <div class="well sidebar-nav">
		   ...
		   <{if $smarty.session.user.base eq "on"}>
              ...
              <li class="active"><a href="<{$app}>/service/index">业务信息</a></li>
		...
		<{foreach $servicepage as $s}>
			<tr>
				<td><{$s.id}></td><td><{$s.title|truncate:15:"...":false}></td><td><{$s.introduct|truncate:15:"...":false}></td>
				
				<td><a href="<{$app}>/service/servicedetail/id/<{$s.id}>">详细</a>|&nbsp;&nbsp;<a href="<{$app}>/service/servicedelete/id/<{$s.id}>">删除</a></td>
			</tr>
		<{/foreach}>
