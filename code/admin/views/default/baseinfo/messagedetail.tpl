...
<div class="span3">
		   ...
		   <{if $smarty.session.user.base eq "on"}>
            ...
            <{if $smarty.session.user.news eq "on"}>
			  ...
			  <{if $smarty.session.user.message eq "on"}>
			    ...
			    <li class="active"><a href="<{$app}>/baseinfo/message">留言</a></li>
	...
	<table  class="gridtable">
			...
			<tr>
				<th>id</th><td><{$messagedetail.id}></td>
			</tr>
		<tr>
				<th>公司名称</th><td><{$messagedetail.companyname}></td>
			</tr>
			<tr>
				<th>姓名</th><td><{$messagedetail.name}></td>
			</tr><tr>
				<th>地址</th><td><{$messagedetail.address}></td>
			</tr><tr>
				<th>手机</th><td><{$messagedetail.phone}></td>
			</tr><tr>
				<th>电子邮件</th><td><{$messagedetail.email}></td>
			</tr>
		
			<tr>
				<th>留言时间</th><td><{$messagedetail.mtime}></td>
			</tr>
		</table>
		<h3 style="text-align:center">留言信息</h3>
		<p style="margin:15px;text-indent:15px;"><{$messagedetail.message}></p>
		  </div>
        </div>
      </div>
