...
<div class="span3">
	...
	<table  class="gridtable">
		...
		<{foreach $usermessage as $message}>
			<tr>
				<td><{$message.id}></td><td><{$message.companyname|truncate:15:"...":false}></td><td><{$message.name|truncate:15:"...":false}></td>
				
				<td><{$message.message|truncate:15:"...":false}></td><td><{$message.mtime|truncate:15:"...":false}></td><td><a href="<{$app}>/baseinfo/messagedetail/id/<{$message.id}>">详细</a>|&nbsp;&nbsp;<a href="<{$app}>/baseinfo/messagedelete/id/<{$message.id}>">删除</a></td>
			</tr>
		<{/foreach}>
