 ...
 <div class="span3">
          <div class="well sidebar-nav">
		   ...
		   <{if $smarty.session.user.base eq "on"}>
			  ...
			  <li class="active"><a href="<{$app}>/baseinfo/service">业务介绍</a></li>
    ...
    <div class="span9">
		  <div class="row-fluid">
			...
			<form class="form-horizontal" method="post" action="<{$app}>/baseinfo/servicesave" enctype="multipart/form-data">
				<fieldset>
