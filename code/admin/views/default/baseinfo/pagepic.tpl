...
<div class="span3">
          <div class="well sidebar-nav">
		   ...
		   <{if $smarty.session.user.base eq "on"}>
              ...
              <li class="active"><a href="<{$app}>/baseinfo/pagepic">网页大图</a></li>
        ...
        <div class="span9">
		  <div class="row-fluid">
			...
			<form class="form-horizontal" action="<{$app}>/baseinfo/pagepicsave"  method="post"  enctype="multipart/form-data">
				<fieldset>
